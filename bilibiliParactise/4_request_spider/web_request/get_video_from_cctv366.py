...
def download_video(proxies):
    ...
    for episode in range(30,31):
        ...
        # 服务器返回视频数据
        home_res = session.get(home_url,headers=header,proxies=proxies)
        # 对响应数据进行编码，避免乱码
        ...
        mp4_name = page_etree.xpath('/html/body/div[3]/div/div[1]/div[2]/ul[1]/li/div[1]/span[2]/text()')
        ...
        print('mp4_name=',mp4_name)
        # mp4_res = session.get(mp4_url, headers=header, proxies=proxies)
