...
-- 删除当天数据
DELETE FROM yj_houses.yj_houses_selling_info_week WHERE data_date = '2021-12-06';
-- 插入数据表
...
FROM (select * from yj_houses.yj_houses_selling_info WHERE data_date = '2021-12-06' AND (
...
left join 
    (select project_name,sold_house_num,sold_not_house_num from yj_houses.yj_houses_selling_info WHERE data_date = '2021-12-05') b 
